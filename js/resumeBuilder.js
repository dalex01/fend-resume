...
var projects = {
	"projects": [
	{
		"title": "Vision",
		"dates": "2014-2015",
		"description": "Development of product line VISION Lifecycle Process Management Framework for avionics development",
...
education.display = function () {
	...
	for (var school = 0; school < education.schools.length; school++) {
		...
		for (var maj=0, len = education.schools[school].major.length; maj < len; maj++) {
